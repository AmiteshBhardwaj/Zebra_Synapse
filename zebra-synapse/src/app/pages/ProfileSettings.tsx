    ...
    if (profile.role === "doctor") {
      ...
      try {
        ...
        localStorage.setItem(
          ...
          JSON.stringify({
            ...parsed,
            currentWeightKg: Number.isFinite(parsedW) && parsedW > 0 ? parsedW : parsed.currentWeightKg,
            heightCm: Number.isFinite(parsedH) && parsedH > 0 ? parsedH : parsed.heightCm,
            age: Number.isFinite(parsedAge) && parsedAge > 0 ? parsedAge : parsed.age,
            gender: gender || parsed.gender,
            activityLevel,
            goal: dietGoal,
            targetWeightKg: parseFloat(targetWeightKg) || parsed.targetWeightKg || (parsedW > 0 ? parsedW : 70),
            dietaryPreference,
            foodAllergies,
            dietaryConditions,
            dietaryNotes,
