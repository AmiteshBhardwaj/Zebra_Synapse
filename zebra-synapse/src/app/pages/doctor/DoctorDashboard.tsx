      ...
      >
        ...
        <div className="flex h-12 shrink-0 items-center border-b border-slate-800/90 px-2.5">
          <div className="flex items-center gap-2.5 overflow-hidden w-full cursor-pointer" onClick={() => navigate("/")}>
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#0077ff]/15 border border-[#0077ff]/30 text-[#0099ff]">
        ...
        >
          <div className="flex items-center gap-2 rounded-lg border border-slate-800 bg-[#141824] p-1.5">
            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md border border-slate-700 bg-slate-800/50">
              <Stethoscope className="w-3.5 h-3.5 text-[#0099ff]" strokeWidth={1.5} />
            </div>
        ...
        <nav className="flex-1 overflow-y-auto p-2 space-y-1.5 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          <button
            ...
            title="My Patients"
            className={`w-full h-9 rounded-xl flex items-center transition-all duration-150 cursor-pointer ${
              location.pathname === "/doctor" || location.pathname.startsWith("/doctor/patient")
                ? "bg-[#0077ff] text-white shadow-md shadow-blue-500/25 font-semibold"
                : "text-white/60 hover:bg-slate-800/60 hover:text-white border border-transparent font-medium"
            }`}
          >
