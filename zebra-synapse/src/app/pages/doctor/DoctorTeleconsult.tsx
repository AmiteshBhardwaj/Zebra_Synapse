...
import PostConsultationWrapUp from "../../components/teleconsult/PostConsultationWrapUp";
    ...
    >
      {viewState === "wrap-up" ? (
        ...
        <PostConsultationWrapUp
          ...
          patientId={activePatientId}
          patientName={activePatientName}
          callDurationSec={completedDuration}
          initialNotes={noteText}
          waitingQueueCount={waitingPatients.length}
          onContinueTeleconsult={() => {
            ...
            setCallActive(false);
            setViewState("queue");
            toast.info("Returned to live waiting queue. Ready for next patient!");
          }}
          onOpenPatientDetail={(pId) => {
            navigate(pId ? `/doctor/patient-detail?id=${pId}` : "/doctor/patients");
          }}
          onReturnToDashboard={() => {
            navigate("/doctor");
          }}
          ...
          <div className="rounded-[26px] bg-gradient-to-r from-[#3E36B0] via-[#4A42C4] to-[#6A61EB] p-6 md:p-8 text-white shadow-xl shadow-[#3E36B0]/15 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="relative z-10 max-w-xl">
              <div className="flex items-center gap-2.5 mb-2">
                ...
                >
                  {viewState === "in-call" ? "Live Call Active" : "Waiting Queue Ready"}
                </span>
              </div>
            ...
            <div className="grid gap-6 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2">
                <VideoCall
                  ...
                  onLeave={(durationSec) => {
                    setCallActive(false);
                    setCompletedDuration(durationSec || 0);
                    setViewState("wrap-up");
                  }}
                />
              </div>
