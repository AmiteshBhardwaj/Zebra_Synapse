  ...
  const setDemoSession = useCallback((role: "patient" | "doctor", email: string) => {
    ...
    const demoData = {
      ...
      profile: {
        id: `demo-${role}-id`,
        role,
        full_name: role === "patient" ? "Maya Thompson" : "Dr. Alex Smith",
        license_number: role === "doctor" ? "MD-98421" : null,
        height_cm: role === "patient" ? 165 : null,
        weight_kg: role === "patient" ? 68.5 : null,
        age: role === "patient" ? 34 : null,
        gender: role === "patient" ? "Female" : null,
        blood_type: role === "patient" ? "O+" : null,
        dietary_preference: role === "patient" ? "omnivore" : null,
        food_allergies: role === "patient" ? [] : null,
        dietary_conditions: role === "patient" ? ["hypertension"] : null,
        dietary_notes: role === "patient" ? "Prefers low-sodium and DASH diet guidelines" : null,
        ...existingProfile,
      },
    };
    try {
