...
export const BIOMARKER_DEFINITIONS: BiomarkerDefinition[] = [
  ...
  },
  {
    ...
    units: ["mg/dL", "mmol/L"],
    patterns: [
      /(?:fasting\s+glucose|glucose,?\s*fasting|fasting\s+blood\s+glucose|fasting\s+blood\s+sugar|fbs|sugar\s*\(fasting\)|blood\s+sugar\s*\(fasting\)|glucose\s*\(fasting\)|s\.?\s*glucose\s*\(fasting\)|plasma\s+glucose\s*fasting)/i,
    ],
    exclude: [/(?:mean\s+blood\s+glucose|post\s*prandial|ppbs)/i],
    reference: "70-99",
    low: 70,
    borderlineHigh: 100,
    high: 126,
  ...
  },
  {
    ...
    exclude: [/(?:hdl|ldl|vldl|chol\/hdl|ldl\/hdl)/i],
    reference: "< 200",
    borderlineHigh: 200,
    high: 240,
    priority: 90,
  ...
  },
  {
    ...
    exclude: [/(?:hba1c|hb\s*a1c|hb\s*a2|foetal\s+hb|fetal\s+hb)/i],
    reference: "12-17",
    low: 12,
    high: 17,
    priority: 82,
  ...
  },
  {
    ...
    units: ["/cmm", "cumm", "10^3/uL", "/uL", "thousand/cu.mm"],
    patterns: [
  ...
  },
  {
    key: "platelets",
    label: "Platelets",
    units: ["/cmm", "cumm", "10^3/uL", "/uL", "lakhs/cu.mm", "lakh/cumm"],
    patterns: [
  ...
  },
  {
    key: "rbc_count",
    label: "RBC Count",
    units: ["million/cmm", "10^6/uL"],
    patterns: [/(?:rbc\s+count|total\s+rbc|red\s+blood\s+cell\s+count)/i],
    reference: "4.5-5.5",
    low: 4.5,
    high: 5.5,
    priority: 58,
  ...
  },
  {
    key: "tsh",
    label: "TSH",
    units: ["microIU/mL", "uIU/mL", "mIU/L"],
    patterns: [/(?:tsh|thyroid\s+stimulating\s+hormone|serum\s+tsh|s\.?\s*tsh)/i],
    reference: "0.35-4.94",
    low: 0.35,
    high: 4.94,
    priority: 72,
