...
values
  (1, 'zebra-seed-patient-1@example.test', 'Maya Thompson', 165.0, 68.5, 34, 'Female', 'O+', 'omnivore', '{}'::text[], array['hypertension']::text[], 4, 'Hypertension', 72, 128, 82, 96, 'elevated', array['Home BP review']::text[]),
